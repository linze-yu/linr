...
```{r, 代码全局设置, echo = F}
knitr::opts_chunk$set(warning = F, error = F, message = F, prompt = F, comment = "", eval = F, echo = T, dpi = 200, cache = T)
# eval = F代码显示不运行
# include = F代码运行, 不显示代码和结果
# echo = T markdown显示代码块
# prompt = T使用>开始代码
# comment = ""结果不使用##
# , cache = T
```
...
devtools::install_github("kassambara/rstatix") # 增加P值
...
devtools::install_github("mdbrown/rmda") # 决策曲线
devtools::install_github("yikeshu0611/ggDCA") # 决策曲线
