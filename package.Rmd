...
```{r,代码全局设置,echo=F}
knitr::opts_chunk$set(warning=F,error=F,message=F,prompt=T,comment='',echo=T,dpi=100,eval=F)
#eval=F代码显示不运行
...
Yuri_theme <- theme(text = element_text(family = "Source Han Sans CN", color = 1),#全字体
                 ...
                 strip.text.x = element_text(hjust = 0.5, margin = margin(0, 0, 0, 0)),#水平分面标签文本
                 strip.text.y = element_text(vjust = 0.5, margin = margin(0, 0, 0, 0)),#竖直分面标签文本
