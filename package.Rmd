...
remotes::install_github("HenrikBengtsson/future", ref = "develop") # 多核计算
...
remotes::install_github("const-ae/ggsignif") # 添加P值
...
remotes::install_github("nucleic-acid/namedropR") # 参考文献
install.packages("Cairo") # PDF字体
remotes::install_github("YuLab-SMU/ggbreak") # 坐标轴截断
...
devtools::install_github("qinwf/jiabaRD") # 中文分词
...
install.packages("caret") # 类似于python的scikitlearn包,提供多种算法的api,同时也有交叉验证,数据预处理等函数,相当强大
